...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 04:32:48
...
(2, 'Lucía Fernández', 'Avenida Sol, 456', '98765432'),
(3, 'Carlos Martínez', 'Calle Luna, 123', '123456789'),
(4, 'Lucía Fernández', 'Avenida Sol, 456', '98765432'),
(5, 'Carlos Martínez', 'Calle Luna, 123', '123456789'),
(6, 'Lucía Fernández', 'Avenida Sol, 456', '98765432');
...
ALTER TABLE `libros`
  ...
  ADD CONSTRAINT `libros_ibfk_2` FOREIGN KEY (`ID_Categoria`) REFERENCES `categorías` (`ID_Categoria`);
